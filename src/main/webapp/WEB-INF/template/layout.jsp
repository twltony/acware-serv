...
<body>
	<nav class="navbar navbar-default" role="navigation">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="${pageContext.request.contextPath}/home">工作面板</a>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
					<li><a class="navbar-brand" href="${pageContext.request.contextPath}/itmanager/list">IT信息管理</a></li>
					<li><a class="navbar-brand" href="${pageContext.request.contextPath}/person/list">人员</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a class="navbar-brand" href="${pageContext.request.contextPath}/logout">注销</a></li>
				</ul>
			<shiro:authenticated>
